...
hparams = HParams(
        ...
        ### Tacotron Training
        tts_schedule = [(2,  1e-3,  10_000,  17),   # Progressive training schedule
                        (2,  5e-4,  15_000,  17),   # (r, lr, step, batch_size)
                        (2,  2e-4,  20_000,  17),   # (r, lr, step, batch_size)
                        (2,  1e-4,  30_000,  17),   #
                        (2,  5e-5,  40_000,  17),   #
                        (2,  1e-5,  60_000,  17),   #
                        (2,  5e-6, 160_000,  17),   # r = reduction factor (# of mel frames
                        (2,  3e-6, 320_000,  17),   #     synthesized for each decoder iteration)
                        (2,  1e-6, 640_000,  17)],  # lr = learning rate
